      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <div className="flex items-center">
              ...
              />
              <span className="text-xl font-bold">SEVEN</span>
            </div>
            <p className="text-gray-400 mt-2 max-w-md">
              Creating exceptional digital experiences with modern technologies and creative solutions.
            </p>
          </div>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-center md:text-left">Social Media</h3>
            <div className="flex justify-center md:justify-start space-x-4">
              ...
              <a 
                href="#" 
                className="bg-gray-800 hover:bg-blue-500 p-3 rounded-full transition-colors"
                aria-label="Twitter"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-500">
            © {currentYear} Portfolio. All rights reserved. Made with <Heart className="h-4 w-4 inline text-red-500" /> by SK7
          </p>
        </div>
      </div>
    </footer>
